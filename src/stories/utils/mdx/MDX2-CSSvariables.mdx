...
:root {
	...
	--n23-asideMenu-background-color: #eee;
	--n23-asideMenu-font-color: var(--n23-color-font);
	--n23-asideMenu-mobile-background-color: #eee;
	--n23-asideMenu-border-right-color: var(--n23-color-font);
