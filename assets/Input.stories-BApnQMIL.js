import{I}from"./Input-B_hhiLlH.js";import"./jsx-runtime-DEdD30eg.js";import"./index-RYns6xqu.js";import"./validator-DPI58GKS.js";const B={title:"Inputs/Input",component:I,parameters:{layout:"centered"},tags:["autodocs"]},a={args:{name:"mylabel",type:"text",label:"Label",onBlur:(e,r)=>console.log(e.target.value,r),errorOptions:{empty:!0}}},t={args:{name:"mylabel",type:"text",label:"Label",placeholder:"Placeholder",onBlur:(e,r)=>console.log(e.target.value,r),errorOptions:{empty:!0,email:!0}}},o={args:{name:"mylabel",type:"text",label:"Label",defaultValue:"@najwer23",onBlur:(e,r)=>console.log(e.target.value,r),errorOptions:{empty:!0}}},l={args:{name:"mylabel",type:"text",label:"Label - Error on blur",defaultValue:"",onBlur:(e,r)=>console.log(e.target.value,r),errorOptions:{empty:!0}}};var n,s,u;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    name: "mylabel",
    type: "text",
    label: "Label",
