...
var css_248z = ".storybook-header{align-items:center;border-bottom:1px solid rgba(0,0,0,.1);display:flex;font-family:Nunito Sans,Helvetica Neue,Helvetica,Arial,sans-serif;justify-content:space-between;padding:15px 20px}.storybook-header h1,.storybook-header svg{display:inline-block;vertical-align:top}.storybook-header h1{font-size:20px;font-weight:700;line-height:1;margin:6px 0 6px 10px}.storybook-header button+button{margin-left:10px}.storybook-header .welcome{color:#333;font-size:14px;margin-right:10px}";
styleInject(css_248z);

var Header = function (_a) {
    var user = _a.user; _a.onLogin; _a.onLogout; _a.onCreateAccount;
    return (jsxRuntime.jsx("header", { children: jsxRuntime.jsxs("div", { className: "storybook-header", children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("svg", { width: "32", height: "32", viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsxs("g", { fill: "none", fillRule: "evenodd", children: [jsxRuntime.jsx("path", { d: "M10 0h12a10 10 0 0110 10v12a10 10 0 01-10 10H10A10 10 0 010 22V10A10 10 0 0110 0z", fill: "#FFF" }), jsxRuntime.jsx("path", { d: "M5.3 10.6l10.4 6v11.1l-10.4-6v-11zm11.4-6.2l9.7 5.5-9.7 5.6V4.4z", fill: "#555AB9" }), jsxRuntime.jsx("path", { d: "M27.2 10.6v11.2l-10.5 6V16.5l10.5-6zM15.7 4.4v11L6 10l9.7-5.5z", fill: "#91BAF8" })] }) }), jsxRuntime.jsx("h1", { children: "Acme" })] }), jsxRuntime.jsx("div", { children: user ? (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs("span", { className: "welcome", children: ["Welcome, ", jsxRuntime.jsx("b", { children: user.name }), "!"] }) })) : (jsxRuntime.jsx(jsxRuntime.Fragment, { children: "mariusz" })) })] }) }));
};
